-- ================================================================
-- MULTI FARM v4 — loading screen fullscreen black (fully.lua style)
-- ================================================================
...
-- ================================================================
-- LOADING SCREEN (fully.lua style — fullscreen black + "wait...")
-- ================================================================
...
local function hideLoading()
    ...
    -- Set text back to "wait..." (biar tidak ke-freeze di dots)
...
print("[MULTI FARM v4] Loaded · fullscreen black loading · skip lock apt")